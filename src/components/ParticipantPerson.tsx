...
export const ParticipantPerson = ({ name }: { name: string }) => {
    const deleteWinner = usePersonsStore(state => state.deleteWinner)
    const deleteParticipant = usePersonsStore(state => state.deleteParticipant)
    const borrar = () => {
        deleteWinner(name)
